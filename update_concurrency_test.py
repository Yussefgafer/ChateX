...
with open('app/src/test/java/com/kai/ghostmesh/mesh/MeshConcurrencyTest.kt', 'r') as f:
    content = f.read()
...
with open('app/src/test/java/com/kai/ghostmesh/mesh/MeshConcurrencyTest.kt', 'w') as f:
    f.write(content)
