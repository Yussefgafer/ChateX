...
## 🏗️ Architecture Standards: Modular Network
...
2. **Mocking Strategy**: Use `MockK` for dependencies. Anetwork real database/network calls in unit tests.
...
---
*Follow these rules to keep the codebase Mesh Clean.*
